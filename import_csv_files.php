	...
	?>
		...
		<p>
			<div id="formatdiv" class="postbox" style="max-width:600px;">
				...
				<div class="inside"><div style="float:right;background-color:#FFFFE0;border: 1px solid #E6DB55;padding:10px;"><b>Note!</b> Post title<br/> and content are <br/>mandatory fields.</div>
					<div id="post-formats-select">
						...
						<?php 
								...
								for ($i=0; $i < $number_of_fields; $i++)
						        {
									 ...
									 if($this->insertype == 'post'){
										$extra = "<option value=\"post_category\">Post Category </option>
											  <option value=\"post_tags\">Post Tags </option>
											  <option value=\"post_slug\">Post Slug </option>";
									}
...
function giw3_admin_actions() {  
    ...
    add_management_page("Import CSV Files", "Import CSV Files","manage_options","import_csv_files", array($plugin, 'main'));  
}  
